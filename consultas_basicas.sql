CREATE DATABASE m4_consultas_negocio;

USE m4_consultas_negocio;
-- ══════════════════════════════════════════
...
SELECT * FROM sales; --SELECT * tiene sentido usarlo cuando queremos conocer cual es la estructura completa de una tabla, en este caso podemos ver como esta compuesta la estructura completa de la tabla "sales" y para corroborar si cargamos bien los datos que previamente cargamos a la tabla.
